...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : START_Pin FX_R_Pin LED_MOD_PIN*/
  GPIO_InitStruct.Pin = START_Pin|FX_R_Pin|LED_MOD_PIN;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  ...
  /*Configure GPIO pins : BT_A_LED_PIN BT_B_LED_PIN BT_C_LED_PIN 
						   BT_D_LED_PIN */
  GPIO_InitStruct.Pin = BT_A_LED_PIN|BT_B_LED_PIN
						|BT_C_LED_PIN|BT_D_LED_PIN;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);		//PA输出
  
  /*Configure GPIO pins : LED_MOD_LED_PIN */
  GPIO_InitStruct.Pin = LED_MOD_LED_PIN;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
